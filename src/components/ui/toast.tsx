...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Consistent top-centered viewport for all screen sizes
      "fixed top-0 left-1/2 z-[100] flex w-full max-w-md -translate-x-1/2 flex-col gap-y-3 p-4 md:max-w-lg",
      "pointer-events-none", // Viewport itself should not catch pointer events
      className
    )}
    {...props}
  />
